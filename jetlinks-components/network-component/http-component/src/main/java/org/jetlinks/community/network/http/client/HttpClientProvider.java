...
public class HttpClientProvider implements NetworkProvider<HttpClientConfig> {
    ...
    @Nonnull
    @Override
    public Mono<Network> createNetwork(@Nonnull HttpClientConfig properties) {
        ...
        return initHttpClient(client, properties);
    }

    @Override
    public Mono<Network> reload(@Nonnull Network network, @Nonnull HttpClientConfig properties) {
    ...
    public Mono<Network> initHttpClient(VertxHttpClient httpClient, HttpClientConfig config) {
    ...
    private Mono<HttpClientOptions> convert(HttpClientConfig config) {
